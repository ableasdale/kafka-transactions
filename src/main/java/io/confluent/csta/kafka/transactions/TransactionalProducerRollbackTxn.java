...
public class TransactionalProducerRollbackTxn {
    ...
    public static void main(String[] args) {
        ...
        props.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "txn-2");
        ...
        try {
            ...
            LOG.info("*** Rolling Back (aborting) uncommitted Transaction ***");
